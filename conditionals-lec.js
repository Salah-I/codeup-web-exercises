...
if (numberoflives === 0) {
    ...
    alert(please continue to next level)
...
if (number > 10){
    ...
    alert("number is not greater")
}
//TODO: Refactor todo#1 as a function named checkIfGameIsOver, that accepts numberOfLives and returns "Sorry, game over" if numberOfLives is 0, else return "Next Level!.
function checktheamountoflives(numberoflives)
var numberoflives = 2
if (numberoflives === 0) {
    alert('game over')
} else {
...
if (weshoulddeletestuff){
    alert("we are deleteing everything")
}
else{
    alert("we didnt cancel everything")
}



//TODO: Write a confirm asking the user if they are 13 years of age or older. If they are, alert "You may proceed", if they are not, alert "Sorry, you are not able to proceed"
var verifyAge = confirm("are you 13 or older")
if (verifyAge) {
...
// they are eligible for license, if they are 16 or older and do not have a
// permit, they are not eligble for a license.
var userAge = 16;
var hasPermit = true;
if (userAge < 15){
    alert("sorry no eligible yet")
} else{
    if (userAge === 15){
        alert("you are eligible for permit")
    } else if (userAge >= 16 && hasPermit === true) {
        alert("you can get a license")
    } else if (userAge >= hasPermit = false) {
